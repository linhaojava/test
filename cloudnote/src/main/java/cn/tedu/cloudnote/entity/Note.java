...
public class Note implements Serializable {
	...
	private long cn_note_last__modify_time;
	...
	public Note(String cn_note_id, String cn_notebook_id, String cn_user_id, String cn_note_status_id,
			...
			long cn_note_last__modify_time) {
		super();
		...
		this.cn_note_last__modify_time = cn_note_last__modify_time;
	}
	...
	public String toString() {
		return "Note [cn_note_id=" + cn_note_id + ", cn_notebook_id=" + cn_notebook_id + ", cn_user_id=" + cn_user_id
				...
				+ cn_note_create_time + ", cn_note_last__modify_time=" + cn_note_last__modify_time + "]";
	}
	...
	public long getCn_note_last__modify_time() {
		return cn_note_last__modify_time;
	}

	public void setCn_note_last__modify_time(long cn_note_last__modify_time) {
		this.cn_note_last__modify_time = cn_note_last__modify_time;
	}
